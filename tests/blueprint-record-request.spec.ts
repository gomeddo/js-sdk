...
const getBlueprintRecordRequest = (): BlueprintRecordRequest => new BlueprintRecordRequest(new GoMeddoAPI('9c30c47d-3033-472e-8bba-cf027322635d', Environment.PRODUCTION))
